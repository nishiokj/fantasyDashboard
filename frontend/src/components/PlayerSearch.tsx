...
import LeagueSignIn from './LeagueSignIn';
...
const PlayerSearch: React.FC<PlayerSearchProps> = ({ onSearch, className }) => {
  ...
  const renderMenu = (
    ...
    >
      {/* if not signed in */}
      <MenuItem onClick={() => {handleMenuClose(); setShowSignIn(true);}}>Sign In</MenuItem>
      {/* if signed in */}
